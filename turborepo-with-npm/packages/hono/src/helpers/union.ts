...
export function unionToZod<T extends readonly []>(values: T): ZodNever
export function unionToZod<T extends readonly [Primitive]>(values: T): ZodLiteral<T[0]>
export function unionToZod<T extends readonly [Primitive, Primitive, ...Primitive[]]>(
  values: T,
